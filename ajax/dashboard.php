...
<div class="box" style="width:80%">
	...
	<div>
		...
		<p class="pb10"> My Reputation Points : <?php echo rep_getter($_SESSION['user']['id']); ?> <a href="javascript:void(0);" title="Take tests, Invite more friends to earn more reputation points!">?</a>	</p>
